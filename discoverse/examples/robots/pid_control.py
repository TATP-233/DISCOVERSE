...
class PIDControl:
    def __init__(self) -> None:
        ...
        self.P_COEFF_TOR = np.array([70000.0, 70000.0, -3000.0])
        self.I_COEFF_TOR = np.array([5.0, 5.0, -1.0])
        self.D_COEFF_TOR = np.array([20000.0, 20000.0, -360.0])
    ...
    def _compute_control(
        ...
        thrust, computed_target_rpy, pos_e = self._pidPositionControl(
            control_timestep,
            cur_pos,
            cur_quat,
            cur_vel,
