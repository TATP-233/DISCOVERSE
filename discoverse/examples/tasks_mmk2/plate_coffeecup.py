...
class SimNode(MMK2TaskBase):
    ...
    def check_success(self):
        ...
        return (
            np.hypot(
                tmat_coffeecup[0, 3] - tmat_cup_lid[0, 3],
                tmat_coffeecup[1, 3] - tmat_cup_lid[1, 3],
            )
            < 0.02
        )
            ...
            if stm.trigger():
                if stm.state_idx == 0:  # 降高度
                    ...
                    sim_node.setArmEndTarget(
                        ...
                        Rotation.from_euler("zyx", [0.0, -0.0551, 0.0]).as_matrix(),
                    )
                    ...
                    if pick_lip_arm == "l":
                        ...
                        sim_node.lft_arm_target_pose[
                            :
                        ] = sim_node.get_tmat_wrt_mmk2base(target_posi)
                        sim_node.setArmEndTarget(
                            sim_node.lft_arm_target_pose,
                            sim_node.arm_action,
                            "l",
