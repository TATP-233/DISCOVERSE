...
from discoverse.task_base.hand_arm_task_base import (
    HandArmTaskBase,
    recoder_hand_with_arm,
)
...
if __name__ == "__main__":
    ...
    transfor = np.array([[0, 0, -1], [-1, 0, 0], [0, 1, 0]])
    ...
    while sim_node.running:
        ...
        if stm.state_idx >= stm.max_state_cnt:
            if sim_node.check_success():
                ...
                process = mp.Process(
                    target=recoder_hand_with_arm,
                    args=(save_path, act_lst, obs_lst, cfg),
                )
                process.start()
