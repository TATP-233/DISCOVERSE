...
class SimNode(AirbotPlayTaskBase):
    ...
    def domain_randomization(self):
        if self.random_level == 0:  # 200
            # 随机 枣子位置
            self.mj_data.qpos[self.nj + 1 + 0] += (
                2.0 * (np.random.random() - 0.5) * 0.05
            )
            self.mj_data.qpos[self.nj + 1 + 1] += (
                2.0 * (np.random.random() - 0.5) * 0.025
            )
            # 随机 杯子位置
            self.mj_data.qpos[self.nj + 7 + 1 + 0] += (
                2.0 * (np.random.random() - 0.5) * 0.05
            )
            self.mj_data.qpos[self.nj + 7 + 1 + 1] += (
                2.0 * (np.random.random() - 0.5) * 0.025
            )
            ...
            # 随机 盘子位置
            self.mj_data.qpos[self.nj + 7 * 2 + 1 + 0] += (
                2.0 * (np.random.random() - 0.5) * 0.0625
            )
            self.mj_data.qpos[self.nj + 7 * 2 + 1 + 1] += (
            ...
            wood_base_bias = 2.0 * (np.random.random(2) - 0.5) * 0.035
            # 随机 盘子位置
            self.mj_data.qpos[self.nj + 7 * 2 + 1 + 0] += (
                2.0 * (np.random.random() - 0.5) * 0.0625 + wood_base_bias[0]
            )
            self.mj_data.qpos[self.nj + 7 * 2 + 1 + 1] += (
                2.0 * (np.random.random() - 0.5) * 0.02 + wood_base_bias[1]
            )
            # 随机 木板位置
            ...
            # 随机 杯子位置
            self.mj_data.qpos[self.nj + 7 + 1 + 0] += (
                2.0 * (np.random.random() - 0.5) * 0.1
            )
            self.mj_data.qpos[self.nj + 7 + 1 + 1] += (
                2.0 * (np.random.random() - 0.5) * 0.05
            )
            wood_base_bias = 2.0 * (np.random.random(2) - 0.5) * 0.05
            # 随机 盘子位置
            self.mj_data.qpos[self.nj + 7 * 2 + 1 + 0] += (
                2.0 * (np.random.random() - 0.5) * 0.0625 + wood_base_bias[0]
            )
    ...
    def check_success(self):
        ...
        return (abs(tmat_cup[2, 2]) > 0.99) and np.hypot(
