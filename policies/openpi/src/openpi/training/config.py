...
_CONFIGS = [
    ...
    # pi0_base by lora
    TrainConfig(
        name="pi0_base_aloha_lora",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAlohaDataConfig(
            repo_id="training_data",# your datasets repo_id
            adapt_to_pi = False,
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
                        {
                            "images": {
                                "cam_high": "observation.images.0",
                                "cam_right_wrist": "observation.images.1",
                            },
                            "state": "observation.state",
                            "actions": "action",
                            "prompt": "prompt",
    ...
    TrainConfig(
                    ...
                    _transforms.RepackTransform(
                        {
                            "images": {
                                "cam_high": "observation.images.0",
                                "cam_left_wrist": "observation.images.1",
                            },
                            "state": "observation.state",
                            "actions": "action",
                            "prompt": "prompt",
     ...
     # pi0_base by full
    TrainConfig(
        name="pi0_base_aloha_full",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="block_place",# your datasets repo_id
            adapt_to_pi = False,
            repack_transforms=_transforms.Group(
                inputs=[
                    _transforms.RepackTransform(
