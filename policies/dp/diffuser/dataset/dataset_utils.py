...
import numba
from policies.dp.diffuser.dataset.replay_buffer import ReplayBuffer
import policies.dp.diffuser.dataset.rotation_conversions as rc
import functools
...
class GaussianNormalizer:
    ...
    def normalize(self, x):
        return (x - self.means[None,]) / self.stds[
            None,
        ]
